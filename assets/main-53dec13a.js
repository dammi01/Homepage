(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function e(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(i){if(i.ep)return;i.ep=!0;const a=e(i);fetch(i.href,a)}})();function g(){return g=Object.assign?Object.assign.bind():function(o){for(var n=1;n<arguments.length;n++){var e=arguments[n];for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(o[t]=e[t])}return o},g.apply(this,arguments)}var v={strings:["These are the default values...","You know what you should do?","Use your own!","Have a great day!"],stringsElement:null,typeSpeed:0,startDelay:0,backSpeed:0,smartBackspace:!0,shuffle:!1,backDelay:700,fadeOut:!1,fadeOutClass:"typed-fade-out",fadeOutDelay:500,loop:!1,loopCount:1/0,showCursor:!0,cursorChar:"|",autoInsertCss:!0,attr:null,bindInputFocusEvents:!1,contentType:"html",onBegin:function(o){},onComplete:function(o){},preStringTyped:function(o,n){},onStringTyped:function(o,n){},onLastStringBackspaced:function(o){},onTypingPaused:function(o,n){},onTypingResumed:function(o,n){},onReset:function(o){},onStop:function(o,n){},onStart:function(o,n){},onDestroy:function(o){}},k=new(function(){function o(){}var n=o.prototype;return n.load=function(e,t,i){if(e.el=typeof i=="string"?document.querySelector(i):i,e.options=g({},v,t),e.isInput=e.el.tagName.toLowerCase()==="input",e.attr=e.options.attr,e.bindInputFocusEvents=e.options.bindInputFocusEvents,e.showCursor=!e.isInput&&e.options.showCursor,e.cursorChar=e.options.cursorChar,e.cursorBlinking=!0,e.elContent=e.attr?e.el.getAttribute(e.attr):e.el.textContent,e.contentType=e.options.contentType,e.typeSpeed=e.options.typeSpeed,e.startDelay=e.options.startDelay,e.backSpeed=e.options.backSpeed,e.smartBackspace=e.options.smartBackspace,e.backDelay=e.options.backDelay,e.fadeOut=e.options.fadeOut,e.fadeOutClass=e.options.fadeOutClass,e.fadeOutDelay=e.options.fadeOutDelay,e.isPaused=!1,e.strings=e.options.strings.map(function(l){return l.trim()}),e.stringsElement=typeof e.options.stringsElement=="string"?document.querySelector(e.options.stringsElement):e.options.stringsElement,e.stringsElement){e.strings=[],e.stringsElement.style.cssText="clip: rect(0 0 0 0);clip-path:inset(50%);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px;";var a=Array.prototype.slice.apply(e.stringsElement.children),s=a.length;if(s)for(var r=0;r<s;r+=1)e.strings.push(a[r].innerHTML.trim())}for(var c in e.strPos=0,e.currentElContent=this.getCurrentElContent(e),e.currentElContent&&e.currentElContent.length>0&&(e.strPos=e.currentElContent.length-1,e.strings.unshift(e.currentElContent)),e.sequence=[],e.strings)e.sequence[c]=c;e.arrayPos=0,e.stopNum=0,e.loop=e.options.loop,e.loopCount=e.options.loopCount,e.curLoop=0,e.shuffle=e.options.shuffle,e.pause={status:!1,typewrite:!0,curString:"",curStrPos:0},e.typingComplete=!1,e.autoInsertCss=e.options.autoInsertCss,e.autoInsertCss&&(this.appendCursorAnimationCss(e),this.appendFadeOutAnimationCss(e))},n.getCurrentElContent=function(e){return e.attr?e.el.getAttribute(e.attr):e.isInput?e.el.value:e.contentType==="html"?e.el.innerHTML:e.el.textContent},n.appendCursorAnimationCss=function(e){var t="data-typed-js-cursor-css";if(e.showCursor&&!document.querySelector("["+t+"]")){var i=document.createElement("style");i.setAttribute(t,"true"),i.innerHTML=`
      ...
      `,document.body.appendChild(i)}},o}()),f=new(function(){function o(){}var n=o.prototype;return n.typeHtmlChars=function(e,t,i){if(i.contentType!=="html")return t;var a=e.substring(t).charAt(0);if(a==="<"||a==="&"){var s;for(s=a==="<"?">":";";e.substring(t+1).charAt(0)!==s&&!(1+ ++t>e.length););t++}return t},n.backSpaceHtmlChars=function(e,t,i){if(i.contentType!=="html")return t;var a=e.substring(t).charAt(0);if(a===">"||a===";"){var s;for(s=a===">"?"<":"&";e.substring(t-1).charAt(0)!==s&&!(--t<0););t--}return t},o}()),S=function(){function o(e,t){k.load(this,t,e),this.begin()}var n=o.prototype;return n.toggle=function(){this.pause.status?this.start():this.stop()},n.stop=function(){this.typingComplete||this.pause.status||(this.toggleBlinking(!0),this.pause.status=!0,this.options.onStop(this.arrayPos,this))},n.start=function(){this.typingComplete||this.pause.status&&(this.pause.status=!1,this.pause.typewrite?this.typewrite(this.pause.curString,this.pause.curStrPos):this.backspace(this.pause.curString,this.pause.curStrPos),this.options.onStart(this.arrayPos,this))},n.destroy=function(){this.reset(!1),this.options.onDestroy(this)},n.reset=function(e){e===void 0&&(e=!0),clearInterval(this.timeout),this.replaceText(""),this.cursor&&this.cursor.parentNode&&(this.cursor.parentNode.removeChild(this.cursor),this.cursor=null),this.strPos=0,this.arrayPos=0,this.curLoop=0,e&&(this.insertCursor(),this.options.onReset(this),this.begin())},n.begin=function(){var e=this;this.options.onBegin(this),this.typingComplete=!1,this.shuffleStringsIfNeeded(this),this.insertCursor(),this.bindInputFocusEvents&&this.bindFocusEvents(),this.timeout=setTimeout(function(){e.strPos===0?e.typewrite(e.strings[e.sequence[e.arrayPos]],e.strPos):e.backspace(e.strings[e.sequence[e.arrayPos]],e.strPos)},this.startDelay)},n.typewrite=function(e,t){var i=this;this.fadeOut&&this.el.classList.contains(this.fadeOutClass)&&(this.el.classList.remove(this.fadeOutClass),this.cursor&&this.cursor.classList.remove(this.fadeOutClass));var a=this.humanizer(this.typeSpeed),s=1;this.pause.status!==!0?this.timeout=setTimeout(function(){t=f.typeHtmlChars(e,t,i);var r=0,c=e.substring(t);if(c.charAt(0)==="^"&&/^\^\d+/.test(c)){var l=1;l+=(c=/\d+/.exec(c)[0]).length,r=parseInt(c),i.temporaryPause=!0,i.options.onTypingPaused(i.arrayPos,i),e=e.substring(0,t)+e.substring(t+l),i.toggleBlinking(!0)}if(c.charAt(0)==="`"){for(;e.substring(t+s).charAt(0)!=="`"&&(s++,!(t+s>e.length)););var h=e.substring(0,t),y=e.substring(h.length+1,t+s),b=e.substring(t+s+1);e=h+y+b,s--}i.timeout=setTimeout(function(){i.toggleBlinking(!1),t>=e.length?i.doneTyping(e,t):i.keepTyping(e,t,s),i.temporaryPause&&(i.temporaryPause=!1,i.options.onTypingResumed(i.arrayPos,i))},r)},a):this.setPauseStatus(e,t,!0)},n.keepTyping=function(e,t,i){t===0&&(this.toggleBlinking(!1),this.options.preStringTyped(this.arrayPos,this));var a=e.substring(0,t+=i);this.replaceText(a),this.typewrite(e,t)},n.doneTyping=function(e,t){var i=this;this.options.onStringTyped(this.arrayPos,this),this.toggleBlinking(!0),this.arrayPos===this.strings.length-1&&(this.complete(),this.loop===!1||this.curLoop===this.loopCount)||(this.timeout=setTimeout(function(){i.backspace(e,t)},this.backDelay))},n.backspace=function(e,t){var i=this;if(this.pause.status!==!0){if(this.fadeOut)return this.initFadeOut();this.toggleBlinking(!1);var a=this.humanizer(this.backSpeed);this.timeout=setTimeout(function(){t=f.backSpaceHtmlChars(e,t,i);var s=e.substring(0,t);if(i.replaceText(s),i.smartBackspace){var r=i.strings[i.arrayPos+1];i.stopNum=r&&s===r.substring(0,t)?t:0}t>i.stopNum?(t--,i.backspace(e,t)):t<=i.stopNum&&(i.arrayPos++,i.arrayPos===i.strings.length?(i.arrayPos=0,i.options.onLastStringBackspaced(),i.shuffleStringsIfNeeded(),i.begin()):i.typewrite(i.strings[i.sequence[i.arrayPos]],t))},a)}else this.setPauseStatus(e,t,!1)},n.complete=function(){this.options.onComplete(this),this.loop?this.curLoop++:this.typingComplete=!0},n.setPauseStatus=function(e,t,i){this.pause.typewrite=i,this.pause.curString=e,this.pause.curStrPos=t},n.toggleBlinking=function(e){this.cursor&&(this.pause.status||this.cursorBlinking!==e&&(this.cursorBlinking=e,e?this.cursor.classList.add("typed-cursor--blink"):this.cursor.classList.remove("typed-cursor--blink")))},n.humanizer=function(e){return Math.round(Math.random()*e/2)+e},n.shuffleStringsIfNeeded=function(){this.shuffle&&(this.sequence=this.sequence.sort(function(){return Math.random()-.5}))},n.initFadeOut=function(){var e=this;return this.el.className+=" "+this.fadeOutClass,this.cursor&&(this.cursor.className+=" "+this.fadeOutClass),setTimeout(function(){e.arrayPos++,e.replaceText(""),e.strings.length>e.arrayPos?e.typewrite(e.strings[e.sequence[e.arrayPos]],0):(e.typewrite(e.strings[0],0),e.arrayPos=0)},this.fadeOutDelay)},n.replaceText=function(e){this.attr?this.el.setAttribute(this.attr,e):this.isInput?this.el.value=e:this.contentType==="html"?this.el.innerHTML=e:this.el.textContent=e},n.bindFocusEvents=function(){var e=this;this.isInput&&(this.el.addEventListener("focus",function(t){e.stop()}),this.el.addEventListener("blur",function(t){e.el.value&&e.el.value.length!==0||e.start()}))},n.insertCursor=function(){this.showCursor&&(this.cursor||(this.cursor=document.createElement("span"),this.cursor.className="typed-cursor",this.cursor.setAttribute("aria-hidden",!0),this.cursor.innerHTML=this.cursorChar,this.el.parentNode&&this.el.parentNode.insertBefore(this.cursor,this.el.nextSibling)))},o}();const C={languageMenu:"Language",english:"English",german:"German",portuguese:"Portuguese",navHome:"Home",navAbout:"About",navHighlights:"Highlights",navSkills:"Skills",navPortfolio:"Portfolio",navContact:"Contact",name:"Michael Dambock",title:"Data Engineer, System Analyst, Backend Developer, Solution Provider",underConstruction:"Under construction!",description:`Experienced Developer with over 20 years in IT, now focused on applying expertise to Data Science,
...
el crecimiento de un equipo dinámico y orientado al futuro.`,skillsHeading:"Habilidades",programming:"Programación",databases:"Bases de Datos",toolsTech:"Herramientas y Tecnologías",dataScience:"Ciencia de Datos",professional:"Habilidades Profesionales",portfolioHeading:"Portafolio",portfolioItems:{crm:{title:"CRM Implementados",description:"Implementación y personalización de sistemas de Gestión de Relaciones con Clientes, mejorando los procesos comerciales y la eficiencia del servicio al cliente."},projectManagement:{title:"Gestión de Proyectos",description:"Gestión y entrega exitosa de proyectos de TI complejos, asegurando la finalización oportuna y la utilización óptima de recursos."},telemarketing:{title:"Sistema de Telemarketing",description:"Desarrollo de soluciones integrales de telemarketing, mejorando el alcance al cliente y el seguimiento del rendimiento de ventas."},webDesign:{title:"Diseño Web",description:"Desarrollo de sitios web modernos y responsivos con enfoque en la experiencia del usuario y el rendimiento."},dashboards:{title:"Dashboards",description:"Tableros interactivos de inteligencia empresarial creados con PowerBI, proporcionando información en tiempo real y visualización de datos para la toma de decisiones informada."}},contactHeading:"Contacto",contactForm:{name:"Su Nombre",email:"Su Correo Electrónico",subject:"Asunto",message:"Su Mensaje",send:"Enviar Mensaje"},navContact:"Contacto"},T={en:C,de:I,pt:w,es:D};class P{constructor(){this.currentLang="en",this.translations=T}setLanguage(n){this.translations[n]&&(this.currentLang=n,this.updateDOM(),localStorage.setItem("preferredLanguage",n),document.querySelectorAll(".language-dropdown button").forEach(e=>{e.classList.toggle("active",e.dataset.lang===n)}))}t(n){const e=n.split(".");let t=this.translations[this.currentLang];for(const i of e){if(t===void 0)return console.log(`Translation missing for key: ${n} in language: ${this.currentLang}`),n;t=t[i]}return t||n}updateDOM(){console.log("Updating translations for language:",this.currentLang),document.querySelectorAll("[data-translate]").forEach(n=>{const e=n.getAttribute("data-translate"),t=this.t(e);if(console.log(`Translating key: ${e} to: ${t}`),t&&t!==e){const i=n.tagName.toLowerCase();i==="input"||i==="textarea"?n.placeholder=t:n.textContent=t}}),document.title=`${this.t("name")} - ${this.t("title")}`,window.dispatchEvent(new CustomEvent("languageChanged",{detail:{language:this.currentLang}}))}init(){console.log("Initializing i18n");const n=localStorage.getItem("preferredLanguage");if(n&&this.translations[n])this.currentLang=n;else{const e=navigator.language.split("-")[0];this.translations[e]&&(this.currentLang=e)}console.log("Current language:",this.currentLang),this.updateDOM(),document.querySelectorAll(".language-dropdown button").forEach(e=>{e.classList.toggle("active",e.dataset.lang===this.currentLang)})}}const u=new P,A={programming:[{name:"Python",icon:"bxl-python"},{name:"JavaScript",icon:"bxl-javascript"},{name:"Java",icon:"bxl-java"},{name:"PHP",icon:"bxl-php"},{name:"C++",icon:"bx-code-alt"}],databases:[{name:"MySQL",icon:"bx-data"},{name:"PostgreSQL",icon:"bx-data"},{name:"MongoDB",icon:"bx-data"},{name:"Oracle",icon:"bx-data"}],tools:[{name:"Git",icon:"bxl-git"},{name:"Docker",icon:"bxl-docker"},{name:"AWS",icon:"bxl-aws"},{name:"Linux",icon:"bxl-tux"},{name:"VS Code",icon:"bx-code-block"}]},E=[];let d=null;function p(){d&&d.destroy();const o={strings:[u.t("title")],typeSpeed:80,backSpeed:50,backDelay:8e3,startDelay:1e3,loop:!0};d=new S(".typed-text",o)}function L(){const o=document.querySelector(".header"),n=50;window.addEventListener("scroll",()=>{window.scrollY>n?o.classList.add("scrolled"):o.classList.remove("scrolled")})}function M(){const o=document.querySelector(".menu-toggle"),n=document.querySelector(".navbar");o.addEventListener("click",()=>{n.classList.toggle("active")}),document.addEventListener("click",e=>{e.target.closest(".header-right")||n.classList.remove("active")})}function x(){const o=document.querySelector(".language-selector"),n=o.querySelector(".language-button"),e=o.querySelector(".language-dropdown");n.addEventListener("click",()=>{e.classList.toggle("show")}),e.querySelectorAll("button").forEach(t=>{t.addEventListener("click",()=>{const i=t.getAttribute("data-lang");u.setLanguage(i),e.classList.remove("show");const a=n.querySelector("span");a.textContent=u.t("languageMenu"),p()})}),document.addEventListener("click",t=>{o.contains(t.target)||e.classList.remove("show")})}function B(){const o={programming:document.querySelector(".skills-category:nth-child(1) .skills-list"),databases:document.querySelector(".skills-category:nth-child(2) .skills-list"),tools:document.querySelector(".skills-category:nth-child(3) .skills-list")};Object.entries(A).forEach(([n,e])=>{const t=o[n];t&&e.forEach(i=>{const a=document.createElement("div");a.className="skill-item fade-in",a.innerHTML=`
        <i class='bx ${i.icon}'></i>
        <span>${i.name}</span>
      `,t.appendChild(a)})})}function z(){const o=document.querySelector(".portfolio-grid");E.forEach(n=>{const e=document.createElement("article");e.className="portfolio-item fade-in",e.innerHTML=`
      ...
      <div class="portfolio-item-content">
        ...
        <a href="${n.link}" class="btn btn-primary" target="_blank">View Project</a>
      </div>
    `,o.appendChild(e)})}function j(){const o=document.getElementById("contact-form");o&&(o.innerHTML=`
    <div class="form-row">
  ...
  `,o.addEventListener("submit",async n=>{n.preventDefault(),console.log("Form submitted")}))}function H(){const o=new IntersectionObserver(n=>{n.forEach(e=>{e.isIntersecting&&(e.target.classList.add("fade-in"),o.unobserve(e.target))})},{threshold:.1});document.querySelectorAll("section").forEach(n=>{o.observe(n)})}function q(){const o=document.getElementById("current-year");o&&(o.textContent=new Date().getFullYear())}function O(){const o=document.getElementById("theme-toggle");o.querySelector("i");const n=localStorage.getItem("theme");window.matchMedia("(prefers-color-scheme: dark)").matches,n?(document.documentElement.setAttribute("data-theme",n),m(n==="dark")):(document.documentElement.setAttribute("data-theme","light"),m(!1)),o.addEventListener("click",()=>{const t=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",t),localStorage.setItem("theme",t),m(t==="dark")})}function m(o){const n=document.getElementById("theme-toggle").querySelector("i");n.className=o?"bx bx-moon":"bx bx-sun"}document.addEventListener("DOMContentLoaded",()=>{u.init(),O(),p(),L(),M(),x(),B(),z(),j(),H(),q(),window.addEventListener("languageChanged",()=>{p()})});
//# sourceMappingURL=main-53dec13a.js.map
