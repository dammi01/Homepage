export default {
  ...
  aboutDescription: `Sou um entusiasta apaixonado por TI e tecnologia em geral.
    ...
    Fórmula 1. Acima de tudo, sou um amante da natureza, encontrando paz e inspiração.`,
  highlightsHeading: "Destaques Profissionais e Objetivos",
  highlightsDescription: `Profissional com mais de quatro décadas de experiência nos setores de tecnologia e administração, minha carreira
...
o crescimento de uma equipe dinâmica e orientada ao futuro.`,
  skillsHeading: "Habilidades",
  programming: "Programação",
  databases: "Bancos de Dados",
  toolsTech: "Ferramentas e Tecnologias",
  dataScience: "Ciência de Dados",
  professional: "Habilidades Profissionais",
  portfolioHeading: "Portfólio",
  portfolioItems: {
    crm: {
      title: "CRMs Implementados",
      description: "Implementação e personalização de sistemas de Gestão de Relacionamento com o Cliente, melhorando processos de negócios e eficiência do atendimento ao cliente."
    },
    projectManagement: {
      title: "Gestão de Projetos",
      description: "Gerenciamento e entrega bem-sucedida de projetos complexos de TI, garantindo conclusão no prazo e utilização otimizada de recursos."
    },
    telemarketing: {
      title: "Sistema de Telemarketing",
      description: "Desenvolvimento de soluções abrangentes de telemarketing, aprimorando o alcance ao cliente e o acompanhamento do desempenho de vendas."
    },
    webDesign: {
      title: "Design de Sites",
      description: "Desenvolvimento de websites modernos e responsivos com foco na experiência do usuário e desempenho."
    },
    dashboards: {
      title: "Dashboards",
      description: "Painéis interativos de business intelligence criados com PowerBI, fornecendo insights em tempo real e visualização de dados para tomada de decisões informada."
    }
  },
