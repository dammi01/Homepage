export default {
  ...
  aboutDescription: `Ich bin ein leidenschaftlicher Enthusiast für IT und Technologie im Allgemeinen.
    ...
    eines Formel-1-Rennens. Vor allem aber bin ich ein Naturliebhaber, der Frieden und Inspiration findet.`,
  highlightsHeading: "Berufliche Highlights und Ziele",
  highlightsDescription: `Als Fachmann mit über vier Jahrzehnten Erfahrung in den Bereichen Technologie und Verwaltung ist meine Karriere
...
Wachstum eines dynamischen und zukunftsorientierten Teams beizutragen.`,
  ...
  portfolioItems: {
    crm: {
      title: "Implementierte CRM-Systeme",
      description: "Implementierung und Anpassung von Customer Relationship Management-Systemen zur Verbesserung von Geschäftsprozessen und Kundenservice-Effizienz."
    },
    projectManagement: {
      title: "Projektmanagement",
      description: "Erfolgreiche Verwaltung und Umsetzung komplexer IT-Projekte mit termingerechter Fertigstellung und optimaler Ressourcennutzung."
    },
    telemarketing: {
      title: "Telemarketing-System",
      description: "Entwicklung umfassender Telemarketing-Lösungen zur Verbesserung der Kundenansprache und Vertriebsleistungsverfolgung."
    },
    webDesign: {
      title: "Website-Design",
      description: "Moderne, responsive Webentwicklung mit Fokus auf Benutzererfahrung und Leistung."
    },
    dashboards: {
      title: "Dashboards",
      description: "Interaktive Business Intelligence-Dashboards erstellt mit PowerBI, die Echtzeit-Einblicke und Datenvisualisierung für fundierte Entscheidungen bieten."
    }
  },
